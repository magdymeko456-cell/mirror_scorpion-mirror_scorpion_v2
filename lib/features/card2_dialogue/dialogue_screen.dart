...
class _DialogueTranslationScreenState extends State<DialogueTranslationScreen> {
  ...
  Future<void> _loadLastLanguages() async {
    ...
    setState(() {
      if (right != null) _rightLang = right;
      if (left != null) _leftLang = left;
    });
  }
    ...
    if (_isListening) {
      ...
      if (available) {
        ...
        _speechToText.listen(
          ...
          localeId: _rightLang, // Always uses right button language for upper editor
        );
      }
    }
  }
  ...
  Widget _buildControlsRow() {
    return Container(
      ...
      child: Row(
        ...
        children: [
          // Left language button (target - for lower editor)
          Expanded(
          ...
          // Right language button (source - for upper editor)
          Expanded(
