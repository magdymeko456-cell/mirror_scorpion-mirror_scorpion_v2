...
// افتراض وجود الخدمات في المشروع كما هي محددة برمجياً
abstract class PremiumVerificationService extends ChangeNotifier {
  String get encryptedDeviceId;
  bool get isLoading;
  Future<bool> activatePremium(String code);
  Future<bool> activateWithServer();
}

Widget buildPremiumCard(BuildContext context, dynamic premiumService, StateSetter setState, refBoolIsPremium) {
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: () async {
                    ...
                    if (success) {
                      setState(() { }); // تحديث الحالة الخارجية للـ UI
