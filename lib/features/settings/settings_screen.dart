              ...
              child: Column(
                children: [
                  ...
                  if (!premium.isPremium) ...[
                    Container(
                      decoration: BoxDecoration(border: Border.all(color: Colors.amber.shade300), borderRadius: BorderRadius.circular(8)),
                      child: Row(
                        children: [
                    ...
                    ElevatedButton(
                      onPressed: () async {
                        if (_patchController.text.isNotEmpty) {
                          ...
                          if (success && mounted) {
                            ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('🎉 تم تفعيل النسخة PRO بنجاح!'), backgroundColor: Colors.green));
                          }
                        }
                      },
