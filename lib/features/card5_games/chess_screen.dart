...
class ChessScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('الشطرنج'), backgroundColor: Colors.teal, foregroundColor: Colors.white),
      body: Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
        ...
        const Text('لعبة الشطرنج مع AI ستكون متاحة قريباً', style: TextStyle(fontSize: 16, color: Colors.grey)),
        const SizedBox(height: 24),
        Container(padding: const EdgeInsets.all(16), margin: const EdgeInsets.symmetric(horizontal: 32),
          ...
          child: const Column(children: [
            ...
            SizedBox(height: 8),
            Text('AI ذكي بثلاث مستويات'), Text('رقعة شطرنج تفاعلية'), Text('تحليل الحركات'),
          ]),
        ),
      ])),
    );
