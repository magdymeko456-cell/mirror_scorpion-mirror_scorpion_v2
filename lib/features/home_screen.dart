...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  void _toggleBubble() {
    ...
    if (service.isEnabled) { service.stopBubble(); } else { service.startBubble(); }
  }
            ...
            SliverPadding(
              ...
              sliver: SliverGrid(
                ...
                delegate: SliverChildListDelegate([
                  ...
                  _buildCard(icon: Icons.sports_esports, title: 'ألعاب 3D', subtitle: 'شطرنج + روبيك', color: Colors.purpleAccent,
