      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          items: languages.map((code) {
            return DropdownMenuItem(value: code, child: Text(_getLanguageName(code)));
          }).toList(),
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          color: isListening ? Colors.red.withOpacity(0.2) : Theme.of(context).colorScheme.primary.withOpacity(0.1),
          shape: BoxShape.circle,
          border: Border.all(color: isListening ? Colors.red : Theme.of(context).colorScheme.primary, width: 2),
        ),
        child: Icon(
...
class ShareButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return IconButton(
      icon: const Icon(Icons.share), iconSize: 20,
      color: Theme.of(context).colorScheme.primary,
      onPressed: onPressed,
      style: IconButton.styleFrom(
        backgroundColor: Theme.of(context).colorScheme.primary.withOpacity(0.1),
